...
from .simulation_driver import DriverFactory, SimulationDriver
...
class TemperatureSimulationDriver(SimulationDriver[float]):
    ...
    def to_driver_data(self) -> SimulationDriverData[float]:
        ...
        d: TemperatureDriverData = TemperatureDriverData(
...
class TemperatureSimulationDriverFactory(DriverFactory[float]):
    ...
    @staticmethod
    def from_dict(d: dict) -> TemperatureSimulationDriver:
        if not "sensor" in d:
        ...
        driver = TemperatureSimulationDriver(sensor=sensor,
